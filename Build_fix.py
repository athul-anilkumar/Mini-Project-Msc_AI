...
os.system("netgenerate --grid --grid.number 4 --grid.length 200 --grid.attach-length 100 --tls.guess --default.lanenumber 2 --default.speed 13.89 -o my_grid.net.xml")
...
print("\nNetwork changed and routes regenerated! Ready for training and demonstration.")